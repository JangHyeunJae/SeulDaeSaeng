 ...
 <main data-aos="fade" data-aos-delay="1500">
          ...
          <div class="row d-flex justify-content-center">
            <div class="text-center">
              <p class="mb-5 d-flex justify-content-between">
                <a href="allBoard.html"><i class="bi bi-chevron-left"></i> 뒤로가기 </a>
                <small class="look"><i class="bi bi-eye"></i> 24 </small>
              </p>
              <p class="mb-0">
                <small class="badge bg-body-secondary mb-3 me-2">자유게시판</small>
                <small >2024-05-03</small>
              </p>
              <h3>게시글 제목입니다.</h3>
              <small>닉네임 (ID)</small>
            </div>
      ...
      <section class="view">
        ...
        <div class="btn-box container d-flex align-items-center justify-content-center pb-5 pt-5 gap-2">
          <a href="allBoard.html" type="button" class="btn btn-secondary">목록으로</a>
