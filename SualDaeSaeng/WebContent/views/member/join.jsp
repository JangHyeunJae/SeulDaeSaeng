            ...
            <div class="col-lg-6">
              <form action="<%=request.getContextPath() %>/member/join.do" method="post" role="form" class="php-email-form needs-validation" novalidate>
			    ...
			    <div class="form-group">
			      ...
			      <div class="col-sm-4">
			        <input type="text" class="form-control" id="postAddr" name="mem_zip" placeholder="우편번호" required>
			    ...
			    <div class="form-group">
			      ...
			      <div class="col-sm-6">
			        <input type="text" class="form-control" id="addr1" name="mem_add1" placeholder="주소" readonly required>
			      </div>
			    </div>
			    
			    <div class="form-group mt-2">
			      <!-- <label for="addr2" class="control-label col-sm-2">상세주소<span class="rq"> *</span></label> -->
			      <input type="text" class="form-control" id="addr2" name="mem_add2" placeholder="상세주소" required>
			    </div>
<!--                 <div class="form-group mt-2">
